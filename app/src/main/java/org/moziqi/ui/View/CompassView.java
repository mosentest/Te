...
public class CompassView extends View {
    ...
    private void initCompassView() {
        ...
        circlePaint.setColor(resources.getColor(R.color.brown));
        ...
        textPaint.setColor(resources.getColor(R.color.lightBlue));
        textHeight = (int) textPaint.measureText("yY");
        markerPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        markerPaint.setColor(resources.getColor(R.color.darkMagenta));
    }
